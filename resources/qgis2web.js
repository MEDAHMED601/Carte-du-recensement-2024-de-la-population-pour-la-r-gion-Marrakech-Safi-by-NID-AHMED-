...
map.getView().fit([-2411576.259619, 2319520.331889, 396468.856926, 4342182.635665], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la région Marrakech-Safi (by NID AHMED)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (188 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation dune carte choroplèthe interactive basée sur la variation de la population entre les différentes provinces de la région de Marrakech Safi selon le recensement du septembre 2024';
            }
